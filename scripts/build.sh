...
${CYAN}Examples:${NC}
  ...
  $0 -r ghcr.io/fpellizz -t 4.4.1 --push

  ${YELLOW}# Using environment variables${NC}
  REGISTRY=myregistry.io IMAGE_TAG=4.4.1 PUSH=true $0
...
echo ""
echo "Next steps:"
echo "  1. Set __IMAGE_TAG__ in your environment folder's deployment.yaml (copied from kubernetes/template/)"
echo "  2. Run: ./scripts/deploy.sh            # deploys kubernetes/panservice-servizi by default"
echo ""
