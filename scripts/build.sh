...
echo ""
echo "Next steps:"
echo "  1. Set the image tag in kubernetes/base/deployment.yaml (or use a release tag)"
echo "  2. Run: ./scripts/deploy.sh            # deploys the panservice overlay by default"
echo ""
